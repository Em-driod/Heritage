...
const Landsecont: React.FC = () => {
  ...
  return (
    <div className="flex flex-col overflow-hidden items-center justify-center min-h-screen bg-white py-8 px-4 sm:py-16 sm:px-6 lg:px-8">
      ...
      {/* Cards Section */}
      <div className="w-full max-w-7xl lg:mt-28 sm:mt-8">
        <div className="flex flex-col lg:flex-row justify-center items-stretch gap-6 sm:gap-8">
          ...
          >
            ...
            <div className="bg-[#FEE2E2] w-11/12 max-w-xs sm:max-w-sm lg:w-[800px] xl:w-[900px] mx-auto rounded-2xl px-2 py-6 shadow-lg mt-4" style={{ minHeight: '400px' }}> {/* Responsive width, minHeight, and heavy mobile margin */}
              {/* Header */}
          ...
          >
            ...
            <div className="bg-[#DCFCE7] w-11/12 max-w-xs sm:max-w-sm lg:w-[800px] xl:w-[900px] mx-auto rounded-2xl px-2 py-6 shadow-lg mt-4" style={{ minHeight: '400px' }}> {/* Changed to bg-white */}
              {/* Header */}
