...
              <div className=" bg-[#FEE2E2] w-[550px] rounded-2xl p-0 relative overflow-hidden  mt-4 shadow-lg " style={{ minHeight: '600px'  }} > {/* Shadow adjusted here */}
                {/* Header */}
...
                      {showKimonoText && (
                        <div className="absolute bg-white bg-opacity-75 w-76 h-48 text-gray-800 text-xs px-2 py-1 rounded-md shadow-2xl  -bottom-7 left-1/2 transform -translate-x-1/8">
...
                          <span className="w-3 h-3 rounded-full bg-gray-800 inline-block mr-0.5"></span>
                          <span className="w-3 h-3 rounded-full bg-gray-500 inline-block mr-0.5"></span>
