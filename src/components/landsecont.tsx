            ...
            <div className="bg-[#FEE2E2] w-[550px] max-w-full mx-auto rounded-2xl px-2 py-6 shadow-lg mt-4 " style={{ minHeight: '400px'  }}> {/* Responsive width, minHeight, and heavy mobile margin */}
              ...
              <div className="px-4 sm:px-6 ">
                <ul className="space-y-3 sm:space-y-4 mt-2">
                  <li className="flex items-center text-xs sm:text-sm text-[#EF4444]"><span className="mr-2 text-lg"> <svg width="20" height="20" fill="#e57373" viewBox="0 0 20 20"><path d="M10 8.586l4.95-4.95 1.414 1.414L11.414 10l4.95 4.95-1.414 1.414L10 11.414l-4.95 4.95-1.414-1.414L8.586 10l-4.95-4.95L5.05 3.636z"/></svg></span>Generic results for common search</li>
