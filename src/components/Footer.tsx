...
const Footer = () => {
  return (
    <footer className="relative flex justify-center items-center min-h-screen py-6 sm:py-8 lg:py-10 font-inter bg-gray-50 overflow-hidden">
      ...
      <div className="relative flex flex-col md:flex-row justify-between gap-2 sm:gap-2.5 lg:gap-3 max-w-6xl w-[85%] sm:w-[70%] lg:w-[60%] mx-auto z-10">
        {/* Left Section */}
        <div className="bg-white rounded-xl sm:rounded-2xl border-1 border-amber-400 p-3 sm:p-4 shadow-lg mt-[120px] sm:mt-[160px] lg:mt-[200px] flex flex-col justify-between w-full sm:w-[320px] lg:w-[400px]">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold leading-tight text-gray-800 mb-4 sm:mb-6 lg:mb-8">
        ...
        <div className="flex flex-col w-full sm:w-auto">
          <div className="relative bg-white  border-1 border-amber-400 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-10 shadow-lg flex flex-col items-start flex-1 min-w-[280px] sm:min-w-[320px] lg:min-w-[350px] overflow-hidden">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">Support</h3>
            <p className="text-sm sm:text-base text-gray-400 mb-1.5 sm:mb-2">Have questions? Get in touch.</p>
            <p className="text-sm sm:text-base text-gray-600 mb-1.5 sm:mb-2">You can email us at</p>
            <a href="mailto:Heritengine@gmail.com" className="font-semibold no-underline mb-4 sm:mb-6 lg:mb-8 hover:underline text-sm sm:text-base">
          ...
          {/* Bottom of support */}
          <div className="bg-white border border-amber-500 w-full rounded-xl sm:rounded-2xl mt-2 sm:mt-2.5 lg:mt-3 h-20 sm:h-24 lg:h-26">
            <div className="flex gap-3 sm:gap-4 lg:gap-5 ml-8 sm:ml-12 lg:ml-20 mt-4 sm:mt-5 lg:mt-7 pt-3 sm:pt-4 lg:pt-5 relative z-10">
              <a href="/terms-of-use" className="text-xs sm:text-sm text-gray-600 no-underline hover:underline">Terms of use</a>
              <a href="/privacy-policy" className="text-xs sm:text-sm text-gray-600 no-underline hover:underline">Privacy Policy</a>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl  border-1 border-amber-400 sm:rounded-2xl p-6 sm:p-8 lg:p-10 shadow-lg flex flex-col items-start flex-0.5 min-w-[120px] sm:min-w-[135px] lg:min-w-[150px]">
          ...
          <div className="flex flex-col gap-8 sm:gap-12 lg:gap-20 justify-between mt-4 sm:mt-6 lg:mt-10">
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 lg:w-12 lg:h-12 rounded-full bg-gray-100 text-gray-800 hover:bg-gray-200 transition-colors">
              <FaInstagram size={20} className="sm:w-6 sm:h-6 lg:w-7 lg:h-7" />
            </a>
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 lg:w-12 lg:h-12 rounded-full bg-gray-100 text-gray-800 hover:bg-gray-200 transition-colors">
              <FaFacebookF size={20} className="sm:w-6 sm:h-6 lg:w-7 lg:h-7" />
            </a>
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 lg:w-12 lg:h-12 rounded-full bg-gray-100 text-gray-800 hover:bg-gray-200 transition-colors">
