    ...
    <footer className="relative flex justify-center items-center max-h-11/12 py-4 sm:py-0 lg:py-10 font-inter bg-white overflow-hidden">
      ...
      <div className="relative flex flex-col md:flex-row justify-between gap-8 sm:gap-2.5 lg:gap-3 max-w-6xl w-[85%] sm:w-[70%] lg:w-[60%] mx-auto z-10">
        ...
        <div className="flex flex-col w-full sm:w-auto">
          <div className="relative bg-white  border-1 border-amber-400 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-10 shadow-xl flex flex-col items-start  flex-1 min-w-[280px] sm:min-w-[320px] lg:min-w-[350px] lg:mb-0 sm:mb-3 overflow-hidden">
            {/* Gradient overlay */}
          ...
          {/* Bottom of support */}
          <div className="bg-white border border-amber-500 w-full rounded-xl sm:rounded-2xl lg:p-0 sm:pl-24 mt-6 sm:mt-4.5 lg:mt-3 h-18 sm:h-12 lg:h-26 shadow-xl">
