...
const Footer = () => {
  return (
    <footer className="flex justify-center items-center min-h-screen py-16 font-inter bg-gray-50">
      <div className="flex flex-col md:flex-row justify-between gap-10 max-w-6xl w-[90%] mx-auto">
        {/* Left Section */}
        <div className="bg-white rounded-2xl p-4 shadow-lg flex flex-col justify-between flex-1 w-[300px]">
          ...
          <div className="flex items-center mt-auto mb-2">
            ...
            <span className="text-xl font-semibold text-gray-800"> <span className='bg-amber-300'>Her</span>itageAI</span>
          </div>
          <p className="text-sm text-gray-600">© 2025 All Rights Reserved. HeritageAI.</p>
        </div>
        ...
        <div className="relative bg-white rounded-2xl p-10 shadow-lg flex flex-col items-start flex-1 min-w-[350px] overflow-hidden">
          ...
          <a href="mailto:Heritage.AI247@gmail.com" className="text-orange-500 font-semibold no-underline mb-8 hover:underline">
          ...
          <div className="flex gap-5 mt-auto pt-5 relative z-10">
 ...
 <div className='bg-white border border-amber-500 w-full rounded-2xl mt-3  h-26'>
        ...
        <div className="bg-white rounded-2xl p-10 shadow-lg flex flex-col items-start flex-0.5 min-w-[150px]">
          <h3 className="text-2xl font-semibold text-gray-800 mb-5">Social</h3>
