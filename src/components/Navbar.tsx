    ...
    <nav className="bg-white shadow-sm border-t-4 border-black fixed top-0 z-50 w-screen">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center">
          <Link to='/'>
            <div className="flex items-center text-gray-800 font-bold text-2xl relative">
              <img src="/heritlogo.png" alt="" className='w-8 h-8 mr-3' />
              <span className='hidden sm:inline'>Heritengine</span>
            </div>
          </Link>
        </div>

        {/* Search Bar - Visible on Mobile, Hidden on Small and up */}
