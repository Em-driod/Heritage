  ...
  return (
    <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mt-20">
        <div className=" grid items-center justify-center px-10 py-5 bg-orange-600 font-semibold rounded-2xl overflow-hidden group transition duration-300 transform hover:scale-105 text-lg min-w-[300px] h-[100px] sm:min-w-[400px] sm:h-[120px] lg:min-w-[500px] lg:h-[140px]"> {/* Increased size for better visual match */}
