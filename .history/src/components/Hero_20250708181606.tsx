...
const AmalaSpecificLoader: React.FC = () => (
  <div className="flex flex-col items-start justify-center bg-gray-50 p-4 rounded-lg border border-gray-200 text-sm text-gray-800 space-y-2">
    ...
    <p><span className="font-semibold text-red-500">Made From:</span> Elubo (yam flour), sometimes cassava flour or plantain flour.</p>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-center gap-8 lg:gap-12 max-w-7xl">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-full lg:max-w-xl px-4 sm:px-0">
            <h1 className="text-4xl md:text-4xl lg:text-4xl font-bold leading-tight text-gray-900 mb-4">
              Ancient Stories.
              <br />Modern Design.
            </h1>
