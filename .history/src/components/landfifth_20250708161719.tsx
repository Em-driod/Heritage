  ...
  return (
    <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between bg-white rounded-3xl shadow-xl p-6 sm:p-10 lg:p-12">
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center justify-between bg-white rounded-3xl shadow-xl p-6 sm:p-10 lg:p-12">
      ...
      <div className="text-center mt-20">
        <button className="inline-flex items-center justify-center px-10 py-5 bg-gradient-to-r from-red-500 to-orange-500 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-105 text-lg">
