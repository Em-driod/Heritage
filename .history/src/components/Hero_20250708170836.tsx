...
const Hero: React.FC = () => {
  ...
  const AmalaSpecificLoader: React.FC = () => (
    <div className="flex flex-col items-center justify-center py-4 px-2">
      <img
        src="/path-to-amala-loading-animation.gif" // <--- REPLACE WITH YOUR AMALA LOADING GIF/IMAGE PATH
        alt="Generating Amala"
        className="w-24 h-auto animate-pulse" // You can adjust width/height and add animation
      />
        ...
        <div className="relative z-10 container mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-center gap-8 lg:gap-12 max-w-7xl">
          ...
          <div className="bg-white rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md lg:max-w-lg mt-8 lg:mt-0">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-8">
              ...
              >
                <img src="/yoruba-culture-image.png" alt="Yoruba Culture" className="absolute inset-0 w-full h-full object-cover" />
              ...
              >
                <img src="/igbo-culture-image.png" alt="Igbo Culture" className="absolute inset-0 w-full h-full object-cover" />
                <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                  Igbo
                </div>
              </button>
              ...
              >
                <img src="/japanese-culture-image.png" alt="Japanese Culture" className="absolute inset-0 w-full h-full object-cover" />
                <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                  Japanese
                </div>
              </button>
