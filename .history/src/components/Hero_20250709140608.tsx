...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Animate the main container fade in
    ...
    // Animate culture buttons
    gsap.from(cultureButtonsRef.current, {
      opacity: 0,
      y: 20,
      stagger: 0.1,
      duration: 0.6,
      ease: "back.out(1.7)",
      delay: 1.2, // Delay after the main sections appear
    });

  }, []);

  // Animation for generated assets when they load
  useEffect(() => {
