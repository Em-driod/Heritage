  ...
  return (
    <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mt-20">
        <div className="relative inline-flex items-center justify-center px-10 py-5 bg-text-orange-600 font-semibold rounded-2xl overflow-hidden group transition duration-300 transform hover:scale-105 text-lg min-w-[300px] h-[100px] sm:min-w-[400px] sm:h-[120px] lg:min-w-[500px] lg:h-[140px]"> {/* Increased size for better visual match */}
          <span className="relative z-10 text-white text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4">Ready to Create with Culture?</span> {/* Text inside the main button */}
          <button className="absolute bottom-4 z-20 px-8 py-3 bg-white text-orange-600 font-semibold rounded-full shadow-md hover:shadow-lg transition duration-200 text-base sm:text-lg"> {/* Inner white button */}
