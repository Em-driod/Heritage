...
const Landfifth = () => {
  return (
    <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      ...
      {/* Call to Action Button at the Bottom - UPDATED TO MATCH image_19dac5.png */}
      <div className="text-center mt-20 px-4"> {/* Added horizontal padding here for overall container */}
        <div className="relative flex flex-col items-center justify-center bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-2xl overflow-hidden group transition duration-300 transform hover:scale-105 shadow-lg mx-auto py-10 sm:py-12 lg:py-16 px-6 sm:px-8 lg:px-10 max-w-4xl"> {/* Adjusted padding and max-width */}
          <span className="text-white text-3xl sm:text-4xl font-extrabold mb-6 sm:mb-8">Ready to Create with Culture?</span> {/* Adjusted margin-bottom */}
          ...
          <p className="mt-6 text-white text-sm opacity-90"> {/* Changed text color to white and added opacity */}
