    ...
    <div className="py-4 sm:py-8 md:py-12 lg:py-24 overflow-hidden"> {/* Add overflow-hidden to prevent horizontal scroll from initial animation */}
      ...
      >
        ...
        >
          ...
          >
            <motion.h1 className="text-4xl md:text-4xl lg:text-5xl font-medium leading-tight text-gray-900 mb-8" >
              Ancient Stories.<br />Modern Design.
            </motion.h1>
            <motion.p className="text-4xl md:text-4xl lg:text-5xl font-serif italic text-gray-900 mb-8" >
              Instantly.
            </motion.p>
            <motion.p className="text-base sm:text-lg text-gray-700 mb-10 max-w-md" >
            ...
            // Applies the same slide-up animation
          ...
          <motion.div
            ...
            // Card specific animation (scale-in)
          >
            ...
            <div className="bg-white rounded-xl shadow-2xl p-0 sm:p-8">
                ...
                {['Yoruba', 'Igbo', 'Japan'].map((culture) => (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }} // Slight scale on tap for buttons
                     // Apply item variants to buttons as well
                  >
              ...
              <AnimatePresence mode="wait"> {/* 'wait' mode ensures new items don't animate in until old ones are out */}
                {isLoading ? (
                  ...
                  <motion.div
                    key="assets" // Key for AnimatePresence
                    initial="hidden"
                    animate="visible"
                  ...
                  >
                    {generatedAssets.map((asset) => (
                      <motion.div
                        key={asset.label}
                        variants={assetItemVariants} // Apply slide-in for each asset
                        initial="hidden"
                        animate="visible"
                        exit="hidden" // Ensure it slides out when unmounted
